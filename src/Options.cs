...
public class Options : OptionInterface
{
    ...
    public override void Initialize()
    {
        ...
        opTabNoir.AddItems(new UIelement[]
        {
            ...
            new OpCheckBox(NoirUseCustomStart, 10f, 460f),
            new OpLabel(40f, 460f, "Custom Start (disable if Story Mode fails to load)") { verticalAlignment = OpLabel.LabelVAlignment.Center },
